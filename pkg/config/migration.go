...
// PIKA-V3: loadConfig was removed from migration.go — it now lives in config.go
// to avoid redeclaration. The function was duplicated when migration.go was
// restored from main for mergeAPIKeys.
